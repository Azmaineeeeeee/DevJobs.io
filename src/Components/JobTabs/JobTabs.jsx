  ...
  return (
    <div className="">
     <Tabs>
       ...
       <Tab className={`px-2 py-2 text-gray-800 font-medium cursor-pointer focus:outline-none border-transparent focus:rounded-xl  focus:bg-purple-800 focus:text-white`} selected>
    On-Site Jobs
</Tab>
          <Tab className="px-2 py-2 text-gray-800 font-medium cursor-pointer focus:outline-none focus:rounded-xl  focus:bg-purple-800 focus:text-white border-transparent">
            Remote Jobs
          </Tab>
          <Tab className="px-2 py-2 text-gray-800 font-medium cursor-pointer focus:outline-none focus:rounded-xl  focus:bg-purple-800 focus:text-white border-transparent">
            Hybrid Jobs
