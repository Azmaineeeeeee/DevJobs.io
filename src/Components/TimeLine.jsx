    ...
    <div>
      <VerticalTimeline layout="1-column">
        ...
        >
          ...
          <p>
            Users log in to access the platform's features, including job
            postings and tech blogs.
          </p>
        </VerticalTimelineElement>
        ...
        >
          ...
          <p>
            Hiring managers post job listings, specifying job titles,
            descriptions, and requirements.
          </p>
          <p>
            Job postings include details such as salary, location, and
        ...
        >
          ...
          <p>
            Job seekers explore available positions, filter by category,
            location, and experience level.
          </p>
          <p>
            They can save favorite jobs, track applications, and receive
        ...
        >
          ...
          <p>
            Users read informative tech blogs, articles, and industry news to
            stay updated with the latest trends.
          </p>
          <p>
            Blogs cover topics such as coding tutorials, career advice, and
            product reviews.
          </p>
        </VerticalTimelineElement>
      </VerticalTimeline>
